            ...
            <div id="paymentForm">
                ...
                {{-- <script>
                        ...
                        document.addEventListener('DOMContentLoaded', function () {
                            const form = document.getElementById('bkashPaymentForm');
                            ...
                            form.addEventListener('submit', function (e) {
                                ...
                                const mobile = document.getElementById('bkash_mobile').value;
                                ...
                                .then(data => {
                                    ...
                                    submitBtn.innerHTML = `bKash পেমেন্ট করুন - ৳ {{ number_format($invoice->amount, 2) }}`;
