...
<div class="p-6">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
        ...
        <form method="GET" action="{{ route('admin.reports.revenue') }}" class="mb-4" id="periodForm">
            <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-4">
                <!-- Quick Period Buttons -->
                <button type="button" onclick="setPeriod('today')" 
                        class="p-4 text-center rounded-lg border {{ $period == 'today' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'border-gray-200 hover:bg-gray-50 hover:border-blue-300' }} transition duration-200">
                ...
                <button type="button" onclick="setPeriod('week')" 
                        class="p-4 text-center rounded-lg border {{ $period == 'week' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'border-gray-200 hover:bg-gray-50 hover:border-blue-300' }} transition duration-200">
                ...
                <button type="button" onclick="setPeriod('month')" 
                        class="p-4 text-center rounded-lg border {{ $period == 'month' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'border-gray-200 hover:bg-gray-50 hover:border-blue-300' }} transition duration-200">
                ...
                <button type="button" onclick="setPeriod('year')" 
                        class="p-4 text-center rounded-lg border {{ $period == 'year' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'border-gray-200 hover:bg-gray-50 hover:border-blue-300' }} transition duration-200">
                ...
                <button type="button" onclick="showCustomDateRange()" 
                        class="p-4 text-center rounded-lg border {{ $period == 'custom' ? 'bg-blue-50 border-blue-500 text-blue-700' : 'border-gray-200 hover:bg-gray-50 hover:border-blue-300' }} transition duration-200">
            ...
            <div id="customDateRange" class="{{ $period == 'custom' ? 'block' : 'hidden' }} bg-blue-50 p-4 rounded-lg border border-blue-200">
                ...
                <div class="mt-3">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <button type="button" onclick="setQuickRange('last7days')" class="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm hover:bg-blue-200 transition duration-200">
                            Last 7 Days
                        </button>
                        <button type="button" onclick="setQuickRange('thisMonth')" class="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm hover:bg-blue-200 transition duration-200">
                            This Month
                        </button>
                        <button type="button" onclick="setQuickRange('thisYear')" class="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm hover:bg-blue-200 transition duration-200">
                            This Year
                        </button>
                        <button type="button" onclick="setQuickRange('lastMonth')" class="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm hover:bg-blue-200 transition duration-200">
                            Last Month
                        </button>
                        <button type="button" onclick="setQuickRange('last30days')" class="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm hover:bg-blue-200 transition duration-200">
                            Last 30 Days
                        </button>
                        <button type="button" onclick="setQuickRange('last90days')" class="inline-flex items-center px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-sm hover:bg-blue-200 transition duration-200">
                            Last 90 Days
                        </button>
                    </div>
                </div>
        ...
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-3xl font-bold mt-2">৳ {{ number_format(isset($data['total']) ? $data['total'] : 0, 2) }}</div>
                    <div class="text-sm opacity-90 mt-1">{{ isset($data['count']) ? $data['count'] : 0 }} payments</div>
                </div>
                <svg class="w-12 h-12 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                </svg>
            </div>
            @if(isset($data['previous']) && $data['previous'] > 0 && isset($data['total']))
                @php
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <div class="text-sm opacity-90 mt-1">
                        {{ isset($data['period']) ? $data['period'] : ($period == 'today' ? 'Today' : ($period == 'year' ? 'This Year' : 'This ' . ucfirst($period))) }}
                    </div>
                </div>
                <svg class="w-12 h-12 opacity-80" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg p-6 border border-green-200">
                ...
                <a href="{{ route('admin.reports.export', ['type' => 'revenue', 'format' => 'csv', 'period' => $period, 'start_date' => $startDate, 'end_date' => $endDate]) }}" 
            ...
            <div class="bg-gradient-to-r from-red-50 to-rose-50 rounded-lg p-6 border border-red-200">
                ...
                <a href="{{ route('admin.reports.export', ['type' => 'revenue', 'format' => 'pdf', 'period' => $period, 'start_date' => $startDate, 'end_date' => $endDate]) }}" 
...
function clearCustomRange() {
    window.location.href = "{{ route('admin.reports.revenue', ['period' => 'month']) }}";
}
